...
namespace hasta_randevu
{
    public partial class Form1 : Form
    {
        ...
        {
            randevuListesi.Add(new Randevu(1, "Medine Kanat", "05327894125", "BESLENME VE DİYET", new DateTime(2023, 12, 18), true));
            randevuListesi.Add(new Randevu(2, "Dilan Kaya", "05329825467", "PSİKOLOG", new DateTime(2023, 12, 20), false));
            randevuListesi.Add(new Randevu(3, "Hiranur Kulakçı", "05359871200", "ORTOPEDİ", new DateTime(2024, 1, 12), true));
            randevuListesi.Add(new Randevu(4, "Sedef Şirin", "05057841214", "KULAK BURUN BOĞAZ", new DateTime(2023, 12, 27), true));
            randevuListesi.Add(new Randevu(5, "Elif Torun", "05414143298", "GENEL CERRAHİ", new DateTime(2023, 12, 20), true));
            randevuListesi.Add(new Randevu(6, "Meryem Ertaş", "05055662211", "DAHİLİYE", new DateTime(2023, 12, 23), false));
